...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.loginStyleMain');
...
var showAlert = function showAlert(type, message) {
  hideAlert();
  var loginMessages = document.querySelector('.loginMessages');
  var markup = "<div class=\"loginStyleMain ".concat(type, "\"><p>").concat(message, "</p></div>");
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"itemFunctions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.clearFields = exports.clearItems = exports.userInfo = exports.deleteItemFromUI = exports.displayUsers = exports.phoneDeleteInfo = exports.phoneInfo = exports.displayCategories = void 0;

var displayCategories = function displayCategories(data, parentEl, heading) {
  clearItems(parentEl);
  var markup = "<h2 class=\"form__heading\">".concat(heading, "</h2>");
  data.forEach(function (el) {
    markup += "\n                <div class=\"form__group\">\n                    <label>Naziv:</label>\n                    <input type=\"text\" disabled value=\"".concat(el.name, "\">\n                    <a class='form__button btn__deleteCategory' id=\"").concat(el._id, "\" href='#'>Izbrisi</a>\n                </div>");
  });
...
exports.phoneDeleteInfo = phoneDeleteInfo;

var displayUsers = function displayUsers(data, parentEl, heading) {
  clearItems(parentEl);
  var markup = "<h2 class=\"form__heading\">".concat(heading, "</h2>");
  data.forEach(function (el) {
    markup += "\n                <div class=\"form__group\">\n                    <label>Ime:</label>\n                    <input type=\"text\" disabled value=\"".concat(el.name, "\">\n                    <label>Email:</label>\n                    <input type=\"text\" disabled value=\"").concat(el.email, "\">\n                    <label>ID:</label>\n                    <input type=\"text\" disabled value=\"").concat(el._id, "\">\n                    <a class='form__button btn__deleteUser' id=\"").concat(el._id, "\" href='#'>Izbrisi</a>\n                </div>");
  });
  parentEl.insertAdjacentHTML('beforeend', markup);
};
...
var deleteItemFromUI = function deleteItemFromUI(elementID) {
  var el = document.getElementById(elementID);
  el.parentNode.parentNode.removeChild(el.parentNode);
};

exports.deleteItemFromUI = deleteItemFromUI;

var userInfo = function userInfo(data, parentEl) {
  clearItems(parentEl);
  var markup = "\n                    <div class=\"form__group\">\n                        <label>Ime:</label>\n                        <input type=\"text\" id=\"update__userName\" value=\"".concat(data.name, "\">\n                    </div>\n                    <div class=\"form__group\">\n                        <label>Email:</label>\n                        <input type=\"text\" id=\"update__userEmail\" value=\"").concat(data.email, "\">\n                    </div>\n                    <div class=\"form__group\">\n                        <label>Uloga:</label>\n                        <input type=\"text\" id=\"update__userRole\" value=\"").concat(data.role, "\">\n                    </div>\n                    <a href=\"#\" class=\"form__button\" id=\"btn__updateUser\">Sacuvaj</a>\n                ");
  parentEl.insertAdjacentHTML('beforeend', markup);
};

exports.userInfo = userInfo;

var clearItems = function clearItems(parentEl) {
  parentEl.innerHTML = '';
};

exports.clearItems = clearItems;

var clearFields = function clearFields(niz) {
...
},{}],"api_functions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.api__updateUser = exports.api__findUser = exports.api__deleteUser = exports.api__createUser = exports.api__deletePhone = exports.api__updatePhone = exports.api__findPhone = exports.api__createPhone = exports.api__deleteCategory = exports.api__createCategory = exports.listItems = exports.logout = exports.login = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _alerts = require("./alerts");

var _itemFunctions = require("./itemFunctions");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('loginSuccess', 'Uspesno ste se ulogovali!');
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', 'Doslo je do greske, probajte kasnije.');
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(url, method, parentElement, heading) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', _context3.t0.response.data.message);
  ...
  return function listItems(_x3, _x4, _x5, _x6) {
...
var api__createCategory =
/*#__PURE__*/
function () {
  var _ref4 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(naziv, fields) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('loginSuccess', 'Kategorija uspesno dodata!');
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', _context4.t0.response.data.message);
  ...
  return function api__createCategory(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}(); // Delete category


exports.api__createCategory = api__createCategory;

var api__deleteCategory =
/*#__PURE__*/
function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('loginSuccess', 'Kategorija uspesno izbrisana!');
              (0, _itemFunctions.deleteItemFromUI)(categoryID);
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', _context5.t0.response.data.message);
  ...
  return function api__deleteCategory(_x9) {
    return _ref5.apply(this, arguments);
  };
}(); // creating new phone


exports.api__deleteCategory = api__deleteCategory;

var api__createPhone =
/*#__PURE__*/
function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('loginSuccess', 'Telefon uspesno dodat!');
              (0, _itemFunctions.clearFields)(fields);
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', _context6.t0.response.data.message);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee7(slug, parentEl, action) {
    var res;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', _context8.t0.response.data.message);
...
var api__deletePhone =
/*#__PURE__*/
function () {
  var _ref9 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee9(slug, parentEl, fields) {
    var res;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('loginSuccess', 'Telefon uspesno obrisan!');
              (0, _itemFunctions.clearFields)(fields);
              (0, _itemFunctions.clearItems)(parentEl);
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', _context9.t0.response.data.message);
...
exports.api__deletePhone = api__deletePhone;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee10(ime, email, sifra, uloga, fields) {
    var res;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', _context10.t0.response.data.message);
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee12(userId, infoParent) {
    var res;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee13(userId, userName, userEmail, userRole, parentEl) {
    var res;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('loginFail', _context13.t0.response.data.message);
...
exports.api__updateUser = api__updateUser;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./itemFunctions":"itemFunctions.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _api_functions = require("./api_functions");

// admin login
var prijaviSe = document.querySelector('.prijaviSe'); // login form functionality
...
if (prijaviSe) {
  prijaviSe.addEventListener('click', function () {
    ...
    if (!email || !password) {
      (0, _alerts.showAlert)('loginFail', 'Popunite oba polja!');
    } else {
      (0, _api_functions.login)(email, password);
    }
  });
} // admin logout


var btn__logout = document.querySelector('.logout');

if (btn__logout) {
  btn__logout.addEventListener('click', function () {
    (0, _api_functions.logout)();
  });
...
var obrisiTelefon = document.querySelector('.obrisiTelefon');
...
var formObrisiTelefon = document.getElementById('formObrisiTelefon');
...
if (dodajKategoriju) {
  dodajKategoriju.addEventListener('click', function () {
    ...
    formObrisiTelefon.style.display = 'none'; // display the form
...
var btn__createCategory = document.getElementById('btn__createCategory');

if (btn__createCategory) {
  btn__createCategory.addEventListener('click', function () {
    var categoryName = document.getElementById('add__categoryName');
    var categoryInput = [categoryName];

    if (!categoryName.value) {
      (0, _alerts.showAlert)('loginFail', 'Morate uneti naziv kategorije!');
    } else {
      (0, _api_functions.api__createCategory)(categoryName.value, categoryInput);
    }
  });
...
if (obrisiKategoriju) {
  obrisiKategoriju.addEventListener('click', function () {
    ...
    formIzmeniRadnika.style.display = 'none';
    formIzmeniTelefon.style.display = 'none';
    formObrisiTelefon.style.display = 'none'; // get all categories from api
  ...
  formObrisiKategoriju.addEventListener('click', function (e) {
    if (e.target.classList.contains('btn__deleteCategory')) {
      if (confirm('Da li ste sigurni da zelite da izbrisete ovu kategoriju?')) {
        ...
        (0, _api_functions.api__deleteCategory)(userID);
      } else {}
    }
  });
} // ////////////////////////// Phone functions
...
var btn__createPhone = document.getElementById('btn__createPhone');
...
if (btn__createPhone) {
  btn__createPhone.addEventListener('click', function () {
    ...
    var dodajTelefonInputFields = [phoneName, phoneModel, phoneYear, phoneMonth, phoneCategory, phonePricePol, phonePriceNov];
...
if (btn__findPhone) {
  btn__findPhone.addEventListener('click', function () {
    ...
    if (!updatePhoneSlug.value) {
      ...
      (0, _api_functions.api__findPhone)(updatePhoneSlug.value, formParent, 'update');
    }
  });
}
...
var btn__findPhoneDelete = document.getElementById('btn__findPhoneDelete');

if (btn__findPhoneDelete) {
  btn__findPhoneDelete.addEventListener('click', function () {
    var deletePhoneSlug = document.getElementById('delete_phoneSlug');
    var formParent = document.querySelector('.phoneDelete__inputContainer');

    if (!deletePhoneSlug.value) {
      (0, _alerts.showAlert)('loginFail', 'Popunite polje!');
    } else {
      (0, _api_functions.api__findPhone)(deletePhoneSlug.value, formParent, 'delete');
    }
  });
}
...
if (formObrisiTelefon) {
  formObrisiTelefon.addEventListener('click', function (e) {
    if (e.target.id === 'btn__deletePhone') {
      var slug = document.getElementById('delete_phoneSlug');
      var parent = document.querySelector('.phoneDelete__inputContainer');
      var fields = [slug];

      if (confirm('Da li ste sigurni da zelite da izbrisete ovaj telefon?')) {
        (0, _api_functions.api__deletePhone)(slug.value, parent, fields);
      }
    }
  });
} // ///////////////////////////// User functions
...
var btn__createUser = document.getElementById('btn__createUser');

if (btn__createUser) {
  btn__createUser.addEventListener('click', function () {
    var userName = document.getElementById('add__userName');
    var userEmail = document.getElementById('add__userEmail');
    var userPassword = document.getElementById('add__userPassword');
    var userRole = document.getElementById('add__userRole');
    var userInputs = [userName, userEmail, userPassword, userRole];

    if (!userName.value || !userEmail.value || !userPassword || !userRole) {
      (0, _alerts.showAlert)('loginFail', 'Popunite sva polja!');
    } else {
      (0, _api_functions.api__createUser)(userName.value, userEmail.value, userPassword.value, userRole.value, userInputs);
    }
  });
} // Deleting user
  ...
  formSpisakRadnika.addEventListener('click', function (e) {
    if (e.target.classList.contains('btn__deleteUser')) {
      if (confirm('Da li ste sigurni da zelite da izbrisete ovog radnika?')) {
        var userID = e.target.id;
        (0, _api_functions.api__deleteUser)(userID);
      } else {}
    }
  });
...
var btn__findUser = document.getElementById('btn__findUser');

if (btn__findUser) {
  btn__findUser.addEventListener('click', function () {
    var userId = document.getElementById('update__userID');
    var userInfoEl = document.querySelector('.form__inputContainer');

    if (!userId.value) {
      (0, _alerts.showAlert)('loginFail', 'Unesite ID korisnika!');
    } else {
      (0, _api_functions.api__findUser)(userId.value, userInfoEl);
    }
  });
}
